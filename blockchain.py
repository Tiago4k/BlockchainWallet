...
class Blockchain:
    ...
    def get_balance(self, sender=None):
        ...
        # (emptylists are returned if the person was NOT the sender)
        ...
        # spend coins before the transaction was
    ...
    def mine_block(self):
        ...
        # Hash the last block (=> to be able to compare it to
        ...
        for itx in block['transactions']:
            for opentx in stored_transactions:
                if (opentx.sender == itx['sender'] and opentx.recipient ==
                    itx['recipient'] and opentx.amount == itx['amount'] and
